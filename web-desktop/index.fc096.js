System.register(["./application.6f8a1.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application6f8a1Js) {
      createApplication = _application6f8a1Js.createApplication;
    }],
    execute: function () {
      createApplication({
